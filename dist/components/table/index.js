...
(function (global, factory) {
  ...
  var script$5 = {
    ...
    components: (_components = {}, _defineProperty(_components, __vue_component__$4.name, __vue_component__$4), _defineProperty(_components, __vue_component__$1.name, __vue_component__$1), _components),
    props: {
  ...
  var script$8 = {
    name: 'BPagination',
    components: (_components$1 = {}, _defineProperty(_components$1, __vue_component__$1.name, __vue_component__$1), _defineProperty(_components$1, __vue_component__$7.name, __vue_component__$7), _components$1),
    // deprecated, to replace with default 'value' in the next breaking change
    model: {
      prop: 'current',
  ...
  var script$9 = {
    ...
    components: _defineProperty({}, __vue_component__$8.name, __vue_component__$8),
    props: {
      paginated: Boolean,
      total: [Number, String],
  ...
  var script$a = {
    name: 'BTable',
    components: (_components$2 = {}, _defineProperty(_components$2, __vue_component__.name, __vue_component__), _defineProperty(_components$2, __vue_component__$1.name, __vue_component__$1), _defineProperty(_components$2, __vue_component__$2.name, __vue_component__$2), _defineProperty(_components$2, __vue_component__$3.name, __vue_component__$3), _defineProperty(_components$2, SlotComponent.name, SlotComponent), _defineProperty(_components$2, __vue_component__$5.name, __vue_component__$5), _defineProperty(_components$2, __vue_component__$6.name, __vue_component__$6), _defineProperty(_components$2, __vue_component__$9.name, __vue_component__$9), _components$2),
    inheritAttrs: false,
      ...
      newColumns: function newColumns() {
        ...
        if (this.columns && this.columns.length) {
          return this.columns.map(function (column) {
            var TableColumnComponent = VueInstance.extend(__vue_component__$6);
  ...
  exports.BTable = __vue_component__$a;
  exports.BTableColumn = __vue_component__$6;
