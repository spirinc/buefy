...
var __chunk_3 = require('./chunk-ce9f10eb.js');
...
var script$3 = {
  name: 'BDatepicker',
  components: (_components = {}, __chunk_1._defineProperty(_components, __vue_component__$1.name, __vue_component__$1), __chunk_1._defineProperty(_components, __vue_component__$2.name, __vue_component__$2), __chunk_1._defineProperty(_components, __chunk_6.Input.name, __chunk_6.Input), __chunk_1._defineProperty(_components, __chunk_16.Field.name, __chunk_16.Field), __chunk_1._defineProperty(_components, __chunk_17.Select.name, __chunk_17.Select), __chunk_1._defineProperty(_components, __chunk_4.Icon.name, __chunk_4.Icon), __chunk_1._defineProperty(_components, __chunk_15.Dropdown.name, __chunk_15.Dropdown), __chunk_1._defineProperty(_components, __chunk_15.DropdownItem.name, __chunk_15.DropdownItem), _components),
