...
var __chunk_13 = require('./chunk-fabbf5a3.js');
...
var script$1 = {
  name: 'BClockpicker',
  components: (_components = {}, __chunk_1._defineProperty(_components, __vue_component__.name, __vue_component__), __chunk_1._defineProperty(_components, __chunk_6.Input.name, __chunk_6.Input), __chunk_1._defineProperty(_components, __chunk_16.Field.name, __chunk_16.Field), __chunk_1._defineProperty(_components, __chunk_4.Icon.name, __chunk_4.Icon), __chunk_1._defineProperty(_components, __chunk_15.Dropdown.name, __chunk_15.Dropdown), __chunk_1._defineProperty(_components, __chunk_15.DropdownItem.name, __chunk_15.DropdownItem), _components),
